...
typedef LikelihoodFieldLaser LaserSensor;
typedef LikelihoodFieldData  LaserSensorData;
//typedef AMCLLaser LaserSensor;
//typedef AMCLLaserData  LaserSensorData;
...
AmclNode::laserReceived(const sensor_msgs::LaserScanConstPtr& laser_scan)
{
  ...
  if(frame_to_laser_.find(laser_scan->header.frame_id) == frame_to_laser_.end())
  {
    ...
    lasers_.push_back(new LaserSensor(*laser_));
  ...
  if(lasers_update_[laser_index])
  {
    ...
    //if( dynamic_cast<LikelihoodFieldLaser>( lasers_[laser_index] ) != NULL )
    //pf_update_sensor( pf_, &likelihoodfield, (AMCLSensorData*)&ldata);
